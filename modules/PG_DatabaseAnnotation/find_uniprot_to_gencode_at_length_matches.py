# find at-length matches (see notes) for uniprot aligning to gencode

from collections import defaultdict

# 'at-length' match criteria
#  - length of match equals the full length of the starting uniprot and gencode entries
#  - no gaps
#  - percent matched is >95%
matches = defaultdict(list)  # uniprot_acc -> list of gencode isoacc with match
