...
namespace Test
{
    ...
    public static class StefanParsimonyTest
    {
        ...
        public static void ParsimonyTreatModifiedFormsAsUnique()
        {
            ...
            // apply parsimony
            ProteinParsimonyEngine pae = new ProteinParsimonyEngine(psmsForParsimony, modPeptidesAreUnique, new CommonParameters(), null, false, new List<string>());
        ...
        public static void ParsimonyWeirdCatch()
        {
            ...
            // apply parsimony
            ProteinParsimonyEngine pae = new ProteinParsimonyEngine(psms, false, new CommonParameters(), null, false, new List<string>());
