...
namespace Test
{
    ...
    public static class RobTest
    {
        ...
        public static void TestParsimony()
        {
            ...
            // run parsimony
            ProteinParsimonyEngine parsimonyEngine = new ProteinParsimonyEngine(psms, false, new CommonParameters(), null, false, new List<string>());
        ...
        public static void TestPTMOutput()
        {
            ...
            ProteinParsimonyEngine engine = new ProteinParsimonyEngine(psms, true, new CommonParameters(), null, false, new List<string> { "ff" });
