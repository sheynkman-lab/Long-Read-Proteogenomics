...
{
    [TestFixture]
    public static class RescueAndResolveTests
    {
        [Test]
        public static void rescueCase1_true()
        {
            ...
            LongReadInfo prot1 = new LongReadInfo(p.ElementAt(0).Accession, 10.0);
        ...
        public static void rescueCase2_true()
        {
            ...
            LongReadInfo prot1 = new LongReadInfo(p.ElementAt(0).Accession, 10.0);
            LongReadInfo prot2 = new LongReadInfo(p.ElementAt(1).Accession, 10.0);
            LongReadInfo prot3 = new LongReadInfo(p.ElementAt(2).Accession, 10.0);
