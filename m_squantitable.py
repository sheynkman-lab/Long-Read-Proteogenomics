...
# proteogenomics framework and proteomics interpretation from Squanti outputs.
#
#### READ ME ####
# This function generates a table of pacbio isoforms from squanti output data
#
# 
# 
# sqtab(squanti_out, ensg_to_gene, enst_to_trans, tabpath):
#                                               inputs:
#                                                   squanti_output file path
...
#
# TO FIX: Some of the SQUANTI pb_acc map to more than 1 gene. I have removed those genes here, but we need to think about how to fix this
...
def sqtab(squanti_out, ensg_to_gene, enst_to_trans, tabpath = "./squanti_isoform_tab.tsv"):
    # Import Jurkat SQUANTI Output Text File
    ...
    data = pd.read_csv(squanti_out, delimiter=r"\s+", usecols = cols)
    ...
    print("Isoform Table from Squanti output has been prepared")
